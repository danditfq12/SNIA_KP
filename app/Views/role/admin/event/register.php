      ...
      <div class="row g-3 align-items-stretch">
        ...
        <div class="col-12 col-lg-7">
          <div class="row g-3">
            ...
            <?php if ($canOffline): ?>
              <div class="col-12">
                <form class="mode-card mode-offline" method="post" action="<?= esc($submitUrl) ?>" onsubmit="return confirmMode('offline')">
                  <?= csrf_field() ?>
            ...
            <?php if ($canOnline): ?>
              <div class="col-12">
                <form class="mode-card mode-online" method="post" action="<?= esc($submitUrl) ?>" onsubmit="return confirmMode('online')">
                  <?= csrf_field() ?>
...
function confirmMode(mode) {
  const modeLabel = mode === 'offline' ? 'Offline (Onsite)' : 'Online (Virtual)';
  return confirm(`Anda yakin ingin mendaftar dengan mode ${modeLabel}?\n\nMode kehadiran tidak dapat diubah setelah pendaftaran.`);
}
</script>
